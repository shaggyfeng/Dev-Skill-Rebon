...
2. Create and run one Tight loop for the exact symptom. If no reproducing environment, captured artifact, or instrumentation permission exists, ask for one instead of hypothesizing.
...
7. Rerun the reproduction, remove temporary instrumentation, remove throwaways, and return the confirmed cause, bounded fix scope, and regression seam.
