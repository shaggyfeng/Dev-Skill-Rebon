...
DevSkill Unslop supports **one 15-hour run without constant human supervision**. It keeps the main context clean, uses bounded subagents, restores state from project files, and selects the right skill from the task. Humans still control design and permissions.
